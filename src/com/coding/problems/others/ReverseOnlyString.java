package com.coding.problems.others;
...
public class ReverseOnlyString {
    ...
    private static String reverseString(String input){
        ...
        while(pointer1 != pointer2){
            while(Character.isDigit(inputArray[pointer1]) || Character.isSpaceChar(inputArray[pointer1])){
                pointer1 ++;
            }
            while (Character.isDigit(inputArray[pointer2]) || Character.isSpaceChar(inputArray[pointer2])){
                pointer2 --;
            }
